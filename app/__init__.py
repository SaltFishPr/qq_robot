...
constant.USER_DICT_PATH = constant.APP_PATH + "/res/user_dict.txt"  # 用户字典路径
constant.SETU_PATH = constant.APP_PATH + "/res/picture/setu"
...
switch_list: list = config['switch_list']  # 接受消息的群列表
...
# setu_list = []  # 存放setu路径
# for setu in os.listdir(constant.SETU_PATH):
